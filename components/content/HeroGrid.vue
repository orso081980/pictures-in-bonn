...
<template>
  <div class="not-prose mt-16 sm:mt-24 content-visibility-visible contain-intrinsic-size-[auto_600px]">
    <div class="flex flex-col sm:flex-row items-center justify-center gap-5 py-4 sm:gap-6 relative z-20">
      <!-- col1 -->
      <div class="w-full sm:w-auto hidden lg:flex flex-col gap-5 sm:gap-6" v-parallax data-rellax-speed="3">
        <div class="relative aspect-[2/3] w-full sm:w-36 lg:w-52 flex-none overflow-hidden rounded-xl bg-zinc-100 dark:bg-zinc-800 mb-4 sm:mb-0">
          <NuxtImg
            placeholder
      ...
      <div class="w-full sm:w-auto flex flex-col gap-5 sm:gap-6" v-parallax data-rellax-speed="1">
        <div class="relative aspect-[4/3] w-full sm:w-44 md:w-52 flex-none overflow-hidden rounded-xl bg-zinc-100 dark:bg-zinc-800 mb-4 sm:mb-0">
          <NuxtImg
            placeholder
            sizes="sm:100vw md:50vw lg:220px"
            class="absolute inset-0 h-full w-full object-cover"
        ...
        <div class="relative aspect-[3/4] w-full sm:w-44 md:w-52 flex-none overflow-hidden rounded-xl bg-zinc-100 dark:bg-zinc-800 mb-4 sm:mb-0">
          <NuxtImg
            placeholder
            sizes="sm:100vw md:50vw lg:220px"
            class="absolute inset-0 h-full w-full object-cover"
      ...
      <div class="w-full sm:w-auto flex flex-col gap-5 sm:gap-6" v-parallax data-rellax-speed="0">
        <div class="relative aspect-[2/3] w-full sm:w-72 md:w-80 lg:w-96 flex-none overflow-hidden rounded-2xl bg-zinc-100 dark:bg-zinc-800 mb-4 sm:mb-0">
          <NuxtImg
            placeholder
      ...
      <!-- col5 -->
      <div class="w-full sm:w-auto hidden lg:flex flex-col gap-5 sm:gap-6" v-parallax data-rellax-speed="3">
        <div class="relative aspect-[2/3] w-full sm:w-44 lg:w-52 flex-none overflow-hidden rounded-xl bg-zinc-100 dark:bg-zinc-800 mb-4 sm:mb-0">
          <NuxtImg
            placeholder
            sizes="sm:100vw md:50vw lg:220px"
            class="absolute inset-0 h-full w-full object-cover"
